...
| Package                                                | OS                                                                     | 
|--------------------------------------------------------|------------------------------------------------------------------------| 
| [Locale](https://pkg.go.dev/gioui.org/x/pref/locale)   | Android 6+  <br> JS <br> Linux <br> Windows Vista+ <br> iOS <br> macOS | 
| [Theme](https://pkg.go.dev/gioui.org/x/pref/theme)     | Android 4+ <br> JS <br> Windows 10+ <br> iOS <br> macOS                | 
